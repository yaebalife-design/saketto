...
.hero__brewery {
  ...
  font-size:1.05rem; color:var(--accent); letter-spacing:.1em; margin-bottom:1rem;
}
.hero__brewery a { color:var(--accent); text-decoration:none; border-bottom:1px dotted var(--accent); }
.hero__name {
...
.spec-cell { padding:1.6rem 1.75rem; border-bottom:1px solid var(--line); }
