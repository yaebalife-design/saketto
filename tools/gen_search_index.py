...
GUIDES = [
    ...
    ("guide/furusato", "ふるさと納税でクラフトサケを手に入れる", "選ぶ・探す", "ふるさと納税 返礼品 寄附 控除 ワンストップ特例 上限 シミュレーション 楽天ふるさと納税 ふるさとチョイス au PAY 品切れ"),
...
PAGES = [
    ...
    ("contact", "お問い合わせ", "サイト情報", "問い合わせ 連絡 掲載依頼 修正依頼 誤り 指摘 取り下げ フォーム"),
]
