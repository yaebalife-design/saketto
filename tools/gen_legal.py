...
PRIVACY_BODY = f"""
  ...
  <h2>3. 広告配信について</h2>
  <p>当サイトでは、第三者配信の広告サービス（もしもアフィリエイト〔楽天市場・Yahoo!ショッピング〕、A8.net〔ふるさと納税ポータル〕等）を利用しています。また、Google AdSense および Amazonアソシエイト・プログラムの利用を準備しています（現在は広告の配信・リンクの掲載を行っていません）。</p>
  <p>これらの広告配信事業者は、利用者の興味に応じた広告を表示するため、当サイトや他のサイトへのアクセスに関する情報（氏名・住所・メールアドレス・電話番号は含まれません）を Cookie を使用して収集する場合があります。</p>
  <p>Google AdSense（導入準備中）における Cookie の利用、パーソナライズ広告の無効化（オプトアウト）については以下をご参照ください。</p>
  <ul>
  ...
  <p>当サイトは、Amazonアソシエイト・プログラムの利用を準備しています。現在、当サイトにAmazonへの広告リンクは掲載していません。掲載を開始した際は、本ページおよび<a href="/disclaimer.html">免責事項・広告表記</a>に明記します。</p>
...
DISCLAIMER_BODY = f"""
  ...
  <div class="disclosure">
    <p>当サイト（saketto）は、アフィリエイト広告を掲載しています。</p>
  </div>
  <p>当サイト（saketto）は、以下のアフィリエイトプログラム・広告サービスを利用しており、リンク経由で商品・サービスが購入された場合、運営者が紹介料を受け取ることがあります。</p>
  <ul>
    <li>もしもアフィリエイト（楽天市場・Yahoo!ショッピング）<span class="note-inline">— 現在利用中</span></li>
    <li>ふるさと納税ポータルのアフィリエイト（楽天ふるさと納税〔もしもアフィリエイト経由〕、au PAY ふるさと納税〔A8.net経由〕等）<span class="note-inline">— 現在利用中</span></li>
    <li>Amazonアソシエイト・プログラム<span class="note-inline">— 準備中（現在、当サイトにAmazonへの広告リンクは掲載していません）</span></li>
    <li>Google AdSense<span class="note-inline">— 準備中（現在、当サイトに広告は配信されていません）</span></li>
  </ul>
...
ABOUT_BODY = f"""
  ...
  <h2>収録の基準 — どの蔵を載せているか</h2>
  <p>「クラフトサケ」に法的な定義はなく、どこまでを含めるかは線の引き方で変わります。saketto では次の基準で収録の可否を判断しています。</p>
  <ul>
    <li><strong>収録する</strong>：清酒製造免許ではなく「その他の醸造酒製造免許」等で、米を主原料に醸す醸造所。副原料を使うもの、搾らないもの（どぶろく）、米麹のみで造るものを含みます</li>
    <li><strong>収録する</strong>：開業準備中の蔵。ただし所在地・運営者・免許のいずれかを公式情報で確認できる場合に限り、その旨を明記します</li>
    <li><strong>収録しない</strong>：清酒のみを造る酒蔵。既存の酒蔵が副次的に手がけるどぶろくも、原則として蔵単位では収録しません</li>
    <li><strong>収録しない</strong>：どぶろく特区の濁酒製造免許のみで造る農家民宿・農家レストラン等。全国に多数存在し、専業の醸造所とは性格が異なるためです</li>
    <li><strong>収録しない</strong>：自社の醸造所を持たない委託醸造ブランド、クラフトビール・果実酒の醸造所</li>
    <li><strong>公式サイトが確認できない蔵は収録を保留</strong>しています。読者が一次情報にたどり着けることを収録の条件としているためです</li>
  </ul>
  <p>この基準に照らして「載っているべき蔵が無い」とお気づきの場合は、お問い合わせよりお知らせください。</p>
