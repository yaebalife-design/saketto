...
{section_meta("09", "REALITY / 実際に、どれだけ買えるのか")}
      <div class="prose">
        ...
        <p>「クラフトサケは手に入りにくい」とよく言われる。では実際どれくらいなのか。saketto では収録している<strong>{S['brands']}銘柄すべてを楽天市場とYahoo!ショッピングで実際に検索し、購入できる出品があるかを一件ずつ確認</strong>している。銘柄名だけでなく蔵名でも検索し、その蔵の出品を一覧して突き合わせる方法をとっている。</p>
