...
(function () {
    ...
    function render() {
      ...
      if (!hits.length) {
        ...
        box.innerHTML = shown.map(function (h) {
          return '<a class="search-hit" role="option" href="/' + h.u + '">' +
                 '<span class="search-hit__name">' + h.n + '</span>' +
                 '<span class="search-hit__meta">' + h.m + '</span></a>';
  ...
  function init() {
    ...
    if (host && !document.getElementById('skNavSearch')) {
